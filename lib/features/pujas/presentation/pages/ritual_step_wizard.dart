  ...
  Widget build(BuildContext context) {
    ...
    if (widget.imageUrls.length == 1) {
      return Container(
        ...
        width: double.infinity,
        decoration: BoxDecoration(
          color: const Color(0XFFEAE1D5).withValues(alpha: 0.08),
        ...
        child: ClipRRect(
          ...
          child: CachedNetworkImage(
            imageUrl: _cleanUrl(widget.imageUrls.first),
            width: double.infinity,
            height: 200,
            fit: BoxFit.contain,
            placeholder: (_, __) => const Center(
              child: SizedBox(
                ...
                child: CircularProgressIndicator(
                  strokeWidth: 2,
                  valueColor: AlwaysStoppedAnimation<Color>(Color(0xFFFFD180)),
                ),
              ),
            ),
            ...
            PageView.builder(
              ...
              itemBuilder: (context, index) {
                return Padding(
                  ...
                  child: CachedNetworkImage(
                    imageUrl: _cleanUrl(widget.imageUrls[index]),
                    width: double.infinity,
                    height: 200,
                    fit: BoxFit.contain,
                    placeholder: (_, __) => const Center(
                      child: SizedBox(
                        ...
                        child: CircularProgressIndicator(
                          strokeWidth: 2,
                          valueColor:
                              AlwaysStoppedAnimation<Color>(Color(0xFFFFD180)),
                        ),
                      ),
                    ),
                    errorWidget: (_, __, ___) => const SizedBox.shrink(),
...
class _CompletionScreen extends StatelessWidget {
  ...
  String get _blessingText {
    ...
    final title = ritual.title.trim();
    final deity = ritual.deity.trim();
    if (deity.isNotEmpty && title.isNotEmpty) {
      return 'May the divine blessings of Lord $deity and $title bestow upon you peace, good health, and boundless prosperity.';
    } else if (title.isNotEmpty) {
      return 'May the divine blessings of $title bestow upon you peace, protection, and boundless prosperity.';
    } else if (deity.isNotEmpty) {
      return 'May Lord $deity bless you and your family with divine peace, prosperity, and happiness.';
    }
    return 'May the divine blessings bestow upon you peace, happiness, and prosperity.';
  }
